...
tstImg = "/home/bernardo/projects/tcc/keras/dsc_1570.jpg"
...
image = Image.new("RGB", (img_width, img_height), "yellow" )
...
#y      -      x
#x = (150y)//17
for x_ in range(len(onlyres)-1):
    for y_ in range(len(onlyres[x_])-1):
        color = onlyres[x_][y_]
        print(onlyres[x_][y_])
